...
public abstract class AbstractJsonLogger implements JsonLogger {
    ...
    public JsonLogger getLogger() {
        this.jsonObjectMore = jsonObject;
        return this;
    }
    ...
    protected String formatMessage(String level) {
        ...
        this.jsonObject.add("host", this.gson.toJsonTree(this.getHostName()));
...
//        }
        ...
        if (this.includeLoggerName) {
            this.jsonObject.add("logger_name", this.gson.toJsonTree(this.slf4jLogger.getClass().getName()));
        }
