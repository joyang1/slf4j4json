...
public class DebugLogger extends AbstractJsonLogger {
    ...
    public DebugLogger(Producer producer, LogConfig conf, FastDateFormat formatter, Gson gson, boolean includeLoggerName) {
        this(conf, formatter, gson, includeLoggerName);
        this.producer = producer;
        this.conf =conf;
    }

    public DebugLogger(LogConfig logConfig, FastDateFormat formatter, Gson gson, boolean includeLoggerName) {
