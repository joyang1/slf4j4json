...
public class ErrorLogger extends AbstractJsonLogger {
    ...
    public ErrorLogger(Producer producer, LogConfig conf, FastDateFormat formatter, Gson gson, boolean includeLoggerName) {
        this(conf, formatter, gson, includeLoggerName);
        this.producer = producer;
        this.conf =conf;
    }

    public ErrorLogger(LogConfig logConfig, FastDateFormat formatter, Gson gson, boolean includeLoggerName) {
